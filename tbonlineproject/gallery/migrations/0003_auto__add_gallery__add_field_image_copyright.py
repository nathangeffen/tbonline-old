...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('gallery_image', 'copyright', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['copyright.Copyright'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('gallery_image', 'copyright_id')
