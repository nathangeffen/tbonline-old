...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Image.preferred_size'
        db.add_column('gallery_image', 'preferred_size', self.gf('django.db.models.fields.CharField')(default='n', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Image.preferred_size'
        db.delete_column('gallery_image', 'preferred_size')
    ...
    models = {
        ...
        'gallery.image': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'preferred_size': ('django.db.models.fields.CharField', [], {'default': "'n'", 'max_length': '1'}),
