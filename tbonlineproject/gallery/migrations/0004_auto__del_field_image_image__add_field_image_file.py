...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('gallery_image', 'image')

        # Adding field 'Image.file'
        db.add_column('gallery_image', 'file', self.gf('filebrowser.fields.FileBrowseField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Image.image'
        db.add_column('gallery_image', 'image', self.gf('filebrowser.fields.FileBrowseField')(max_length=200, null=True, blank=True), keep_default=False)

        # Deleting field 'Image.file'
        db.delete_column('gallery_image', 'file')
