...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'OrderedImage', fields ['image', 'gallery']
        db.create_unique('gallery_orderedimage', ['image_id', 'gallery_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'OrderedImage', fields ['image', 'gallery']
        db.delete_unique('gallery_orderedimage', ['image_id', 'gallery_id'])
