...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BasicPost.content_format'
        db.delete_column('post_basicpost', 'content_format')

        # Changing field 'PostWithEmbeddedObject.single_post_embedded_html'
        db.alter_column('post_postwithembeddedobject', 'single_post_embedded_html', self.gf('enhancedtext.fields.EnhancedTextField')())

        # Changing field 'PostWithEmbeddedObject.many_post_embedded_html'
        db.alter_column('post_postwithembeddedobject', 'many_post_embedded_html', self.gf('enhancedtext.fields.EnhancedTextField')())


    def backwards(self, orm):
        
        # Adding field 'BasicPost.content_format'
        db.add_column('post_basicpost', 'content_format', self.gf('django.db.models.fields.CharField')(default='W', max_length=1), keep_default=False)

        # Changing field 'PostWithEmbeddedObject.single_post_embedded_html'
        db.alter_column('post_postwithembeddedobject', 'single_post_embedded_html', self.gf('django.db.models.fields.TextField')())

        # Changing field 'PostWithEmbeddedObject.many_post_embedded_html'
        db.alter_column('post_postwithembeddedobject', 'many_post_embedded_html', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'post.basicpost': {
            ...
            'body': ('django.db.models.fields.TextField', [], {'default': "'\\\\W'", 'blank': 'True'}),
            'copyright': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['copyright.Copyright']", 'null': 'True', 'blank': 'True'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
