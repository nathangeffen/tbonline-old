...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BasicPost.tags'
        db.delete_column('post_basicpost', 'tags')


    def backwards(self, orm):
        
        # Adding field 'BasicPost.tags'
        db.add_column('post_basicpost', 'tags', self.gf('tagging.fields.TagField')(default=''), keep_default=False)
