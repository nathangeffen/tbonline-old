...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PostWithSlideshow.gallery'
        db.add_column('post_postwithslideshow', 'gallery', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gallery.Gallery'], null=True, blank=True), keep_default=False)

        # Changing field 'PostWithImage.image'
        db.alter_column('post_postwithimage', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gallery.Image'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PostWithSlideshow.gallery'
        db.delete_column('post_postwithslideshow', 'gallery_id')

        # Changing field 'PostWithImage.image'
        db.alter_column('post_postwithimage', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['gallery.Image']))
