...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PostWithEmbeddedObject.id'
        db.delete_column('post_postwithembeddedobject', 'id')

        # Adding field 'PostWithEmbeddedObject.basicpost_ptr'
        db.add_column('post_postwithembeddedobject', 'basicpost_ptr', self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['post.BasicPost'], unique=True, primary_key=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'PostWithEmbeddedObject.id'
        db.add_column('post_postwithembeddedobject', 'id', self.gf('django.db.models.fields.AutoField')(default=0, primary_key=True), keep_default=False)

        # Deleting field 'PostWithEmbeddedObject.basicpost_ptr'
        db.delete_column('post_postwithembeddedobject', 'basicpost_ptr_id')
