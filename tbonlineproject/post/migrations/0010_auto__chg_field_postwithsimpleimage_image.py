...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PostWithSimpleImage.image'
        db.alter_column('post_postwithsimpleimage', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'PostWithSimpleImage.image'
        db.alter_column('post_postwithsimpleimage', 'image', self.gf('sorl.thumbnail.fields.ImageField')(default=1, max_length=100))
