...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BasicPost.teaser'
        db.alter_column('post_basicpost', 'teaser', self.gf('enhancedtext.fields.EnhancedTextField')())


    def backwards(self, orm):
        
        # Changing field 'BasicPost.teaser'
        db.alter_column('post_basicpost', 'teaser', self.gf('django.db.models.fields.TextField')())
