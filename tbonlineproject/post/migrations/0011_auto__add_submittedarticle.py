...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SubmittedArticle'
        db.create_table('post_submittedarticle', (
        ...
        db.send_create_signal('post', ['SubmittedArticle'])


    def backwards(self, orm):
        
        # Deleting model 'SubmittedArticle'
        db.delete_table('post_submittedarticle')
