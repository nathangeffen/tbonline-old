...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PostWithSimpleImage'
        db.create_table('post_postwithsimpleimage', (
        ...
        db.send_create_signal('post', ['PostWithSimpleImage'])


    def backwards(self, orm):
        
        # Deleting model 'PostWithSimpleImage'
        db.delete_table('post_postwithsimpleimage')
