...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrderedImage.post_with_slideshow'
        db.alter_column('post_orderedimage', 'post_with_slideshow_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['post.PostWithSlideshow']))
