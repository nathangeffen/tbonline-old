...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BasicPost.copyright'
        db.add_column('post_basicpost', 'copyright', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['copyright.Copyright'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BasicPost.copyright'
        db.delete_column('post_basicpost', 'copyright_id')
