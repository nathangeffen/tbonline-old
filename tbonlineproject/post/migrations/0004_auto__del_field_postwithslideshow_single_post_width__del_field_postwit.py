...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PostWithSlideshow.single_post_width'
        db.delete_column('post_postwithslideshow', 'single_post_width')

        # Deleting field 'PostWithSlideshow.many_post_width'
        db.delete_column('post_postwithslideshow', 'many_post_width')

        # Deleting field 'PostWithSlideshow.single_post_height'
        db.delete_column('post_postwithslideshow', 'single_post_height')

        # Deleting field 'PostWithSlideshow.many_post_height'
        db.delete_column('post_postwithslideshow', 'many_post_height')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'PostWithSlideshow.single_post_width'
        db.add_column('post_postwithslideshow', 'single_post_width', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PostWithSlideshow.many_post_width'
        db.add_column('post_postwithslideshow', 'many_post_width', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PostWithSlideshow.single_post_height'
        db.add_column('post_postwithslideshow', 'single_post_height', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PostWithSlideshow.many_post_height'
        db.add_column('post_postwithslideshow', 'many_post_height', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    ...
    models = {
        ...
        'post.postwithslideshow': {
            ...
            'animation_time': ('django.db.models.fields.PositiveIntegerField', [], {'default': '600'}),
            'basicpost_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['post.BasicPost']", 'unique': 'True', 'primary_key': 'True'}),
            'delay': ('django.db.models.fields.PositiveIntegerField', [], {'default': '10000'}),
            'gallery': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['gallery.Gallery']", 'null': 'True', 'blank': 'True'}),
            'resize_contents': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'sites.site': {
