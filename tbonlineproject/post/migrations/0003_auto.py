...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field sites on 'BasicPost'
        db.create_table('post_basicpost_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('basicpost', models.ForeignKey(orm['post.basicpost'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('post_basicpost_sites', ['basicpost_id', 'site_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field sites on 'BasicPost'
        db.delete_table('post_basicpost_sites')
