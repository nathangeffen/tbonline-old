...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmittedArticle.submitted_on'
        db.add_column('post_submittedarticle', 'submitted_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 12, 21), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SubmittedArticle.submitted_on'
        db.delete_column('post_submittedarticle', 'submitted_on')
