...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'BasicPost', fields ['slug']
        db.delete_unique('post_basicpost', ['slug'])

        # Adding unique constraint on 'BasicPost', fields ['date_published', 'slug']
        db.create_unique('post_basicpost', ['date_published', 'slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'BasicPost', fields ['date_published', 'slug']
        db.delete_unique('post_basicpost', ['date_published', 'slug'])

        # Adding unique constraint on 'BasicPost', fields ['slug']
        db.create_unique('post_basicpost', ['slug'])
