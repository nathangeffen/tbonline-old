...
urlpatterns += patterns('',
    ...
    url(r'^post/anonymous/$',              'CommentRecaptcha.views.post_comment',        name='comments-post-comment-anonymous'),
    url(r'^verify/$',                      'CommentRecaptcha.views.verify_comment',      name='comment-verify-comment')
)
